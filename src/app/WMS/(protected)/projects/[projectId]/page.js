...
export default function ProjectDetailPage() {
  ...
  console.log("Project Status:", project?.status, "Is Completed:", isCompleted);
      ...
      <div className="bg-white border-b shadow-sm">
        <div className="px-6 py-6 mx-auto max-w-7xl">
          <div className="flex items-center mb-4">
            <Link href="/WMS/projects" className="flex items-center mr-4 text-blue-600 transition-colors hover:text-blue-800">
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex flex-col gap-2 text-gray-600 sm:flex-row sm:items-center">
                ...
                <span>
                  Monument:
                  <Link href={`/WMS/monuments/${monument?.id}`} className="ml-1 font-medium text-blue-600 hover:text-blue-800">
